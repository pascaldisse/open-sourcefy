...
int text_helper_00001056(void)
{
    ...
    // Converted from assembly instructions:
    // 0x1056: call 
    // Assembly: call dword ptr [0x4d2550]
    result = function_ptr();
    // 0x105c: ret 
    // Assembly: ret 
    return result;
    ...
    // int3 
    // 0x1060: mov 
    // Assembly: mov eax, dword ptr [ecx + 0x20]
...
int text_x86_00001070(void)
{
    ...
    // 0x107a: mov 
    // Assembly: mov dword ptr [esi + 0x58], eax
    *((int*)(memory_access)) = result;
    // 0x107d: mov 
    // Assembly: mov dword ptr [esi + 0x54], eax
    *((int*)(memory_access)) = result;
    // 0x1080: mov 
    // Assembly: mov dword ptr [esi], 0x4a9988
...
int text_x86_000010a8(void)
{
    ...
    // 0x10af: mov 
    // Assembly: mov dword ptr [esi + 0x58], ebx
    *((int*)(memory_access)) = temp1;
    // 0x10b2: mov 
    // Assembly: mov dword ptr [esi + 0x54], 0
    memory_access = 0;
    // 0x10b9: call 
    // Assembly: call dword ptr [0x4a97b8]
    result = function_ptr();
    // 0x10bf: push 
...
int text_x86_000010e0(void)
{
    ...
    src_ptr = counter;
    // 0x10e9: mov 
    // Assembly: mov ecx, dword ptr [ebp + 8]
    counter = *((int*)(memory_access));
    // 0x10ec: fld 
    // Assembly: fld dword ptr [ecx]
    // fld dword ptr [ecx]
    // 0x10ee: mov 
    // Assembly: mov eax, dword ptr [esi + 0x54]
    result = *((int*)(memory_access));
    // 0x10f1: fmul 
    // Assembly: fmul dword ptr [0x4a9ad0]
    // fmul dword ptr [0x4a9ad0]
    // 0x10f7: mov 
    // Assembly: mov dword ptr [ebp - 4], eax
    *((int*)(memory_access)) = result;
    // 0x10fa: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    // 0x10fb: mov 
    // Assembly: mov edi, dword ptr [0x4a97bc]
    dst_ptr = *((int*)(memory_access));
    // 0x1101: fadd 
    // Assembly: fadd dword ptr [esi + 0x54]
    // fadd dword ptr [esi + 0x54]
    // 0x1104: fstp 
    // Assembly: fstp dword ptr [ebp + 8]
    // fstp dword ptr [ebp + 8]
    // 0x1107: fld 
    // Assembly: fld dword ptr [ebp + 8]
    // fld dword ptr [ebp + 8]
    // 0x110a: mov 
    // Assembly: mov edx, dword ptr [ebp + 8]
...
int text_helper_0000111b(void)
{
    ...
    // 0x111b: jne 
    // Assembly: jne 0x112e
    if (!zero_flag) goto label_112e;
    // 0x111d: mov 
    // Assembly: mov eax, dword ptr [esi + 0x20]
    result = *((int*)(memory_access));
    // 0x1120: push 
    // Assembly: push 0
    // Push 0 to stack
...
int text_x86_00001190(void)
{
    ...
    // 0x1196: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
    // 0x1199: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    src_ptr = counter;
    // 0x119c: mov 
    // Assembly: mov ecx, dword ptr [eax + 0x18]
    counter = *((int*)(memory_access));
    // 0x119f: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    ...
    // 0x11aa: je 
    // Assembly: je 0x1294
    if (zero_flag) goto label_1294;
    // 0x11b0: fld 
    // Assembly: fld dword ptr [esi + 0x54]
    // fld dword ptr [esi + 0x54]
    // 0x11b3: fmul 
    // Assembly: fmul dword ptr [0x4a9ac8]
    // fmul dword ptr [0x4a9ac8]
    // 0x11b9: call 
...
int text_x86_000011d4(void)
{
    ...
    // 0x11d8: jbe 
    // Assembly: jbe 0x1259
    if (jbe_condition) goto label_1259;
    // 0x11da: lea 
    ...
    // lea edx, [esi - 5]
    // 0x11eb: mov 
    // Assembly: mov dword ptr [ebp - 0x10], edx
...
int text_x86_000012a0(void)
{
    ...
    result = func_1020();
    // 0x12ab: test 
    // Assembly: test byte ptr [ebp + 8], 1
    // Compare: byte ptr [ebp + 8] vs 1
    // 0x12af: je 
    // Assembly: je 0x12ba
    if (zero_flag) goto label_12ba;
    // 0x12b1: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x12b2: call 
...
int text_x86_00001350(void)
{
    ...
    result = *((int*)(memory_access));
    // 0x1356: mov 
    // Assembly: mov eax, dword ptr [eax]
    result = *((int*)(memory_access));
    // 0x1358: cmp 
    // Assembly: cmp eax, 3
    // Compare: result vs 3
    // 0x135b: jne 
    // Assembly: jne 0x137c
    if (!zero_flag) goto label_137c;
    // 0x135d: mov 
    // Assembly: mov ecx, dword ptr [0x4a9ca8]
    counter = *((int*)(memory_access));
    // 0x1363: mov 
    // Assembly: mov dl, byte ptr [0x4a9cac]
    result = memory_access;
    // 0x1369: mov 
    // Assembly: mov dword ptr [0x4d2574], ecx
    *((int*)(memory_access)) = counter;
    // 0x136f: mov 
    // Assembly: mov byte ptr [0x4d2578], dl
    memory_access = dl;
    // 0x1375: mov 
...
int text_x86_000013c0(void)
{
    ...
    // 0x13ca: mov 
    // Assembly: mov eax, dword ptr fs:[0]
    result = *((int*)(memory_access));
    // 0x13d0: push 
    // Assembly: push eax
    // Push result to stack
    // 0x13d1: mov 
    // Assembly: mov dword ptr fs:[0], esp
...
int text_func_0400(void)
{
    ...
    // lea ecx, [ebp - 0x10]
    // 0x1413: call 
    // Assembly: call dword ptr [0x4a93ec]
    result = function_ptr();
    // 0x1419: mov 
    // Assembly: mov eax, dword ptr [0x4d2568]
    result = *((int*)(memory_access));
    // 0x141e: lea 
    ...
    // Push counter to stack
    // 0x1427: mov 
    // Assembly: mov dword ptr [ebp - 4], 0
    memory_access = 0;
    // 0x142e: mov 
    // Assembly: mov dword ptr [ebp - 0x14], eax
    *((int*)(memory_access)) = result;
    // 0x1431: call 
...
int text_x86_00001500(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x1503: mov 
    // Assembly: mov edx, dword ptr [ebp + 0xc]
    temp2 = *((int*)(memory_access));
    // 0x1506: mov 
    // Assembly: mov eax, dword ptr [ecx]
    result = *((int*)(memory_access));
    // 0x1508: push 
    // Assembly: push edx
    // Push temp2 to stack
    // 0x1509: movzx 
    // Assembly: movzx edx, word ptr [ebp + 8]
    // movzx edx, word ptr [ebp + 8]
    // 0x150d: push 
    // Assembly: push edx
    // Push temp2 to stack
    // 0x150e: call 
    // Assembly: call dword ptr [eax + 0x13c]
    result = function_ptr();
    // 0x1514: pop 
    // Assembly: pop ebp
    // Pop from stack to frame_ptr
...
int text_x86_00001590(void)
{
    ...
    // lea edi, [ebp - 0x54]
    // 0x15a1: rep stosd 
    // Assembly: rep stosd dword ptr es:[edi], eax
    // rep stosd dword ptr es:[edi], eax
    // 0x15a3: mov 
    // Assembly: mov ecx, dword ptr [0x4d2570]
    counter = *((int*)(memory_access));
    // 0x15a9: mov 
    // Assembly: mov edx, dword ptr [ecx + 0x20]
    temp2 = *((int*)(memory_access));
    // 0x15ac: mov 
    // Assembly: mov dword ptr [ebp - 0x10], eax
    *((int*)(memory_access)) = result;
    // 0x15af: mov 
    // Assembly: mov dword ptr [ebp - 0xc], eax
    *((int*)(memory_access)) = result;
    // 0x15b2: mov 
    // Assembly: mov dword ptr [ebp - 8], eax
    *((int*)(memory_access)) = result;
    // 0x15b5: push 
    // Assembly: push edx
    // Push temp2 to stack
    // 0x15b6: mov 
    // Assembly: mov dword ptr [ebp - 0x54], 0x44
    memory_access = 0x44;
    // 0x15bd: mov 
    // Assembly: mov dword ptr [ebp - 4], eax
    *((int*)(memory_access)) = result;
...
int text_x86_00001720(void)
{
    ...
    // 0x172e: je 
    // Assembly: je 0x1764
    if (zero_flag) goto label_1764;
    // 0x1730: mov 
    // Assembly: mov eax, dword ptr [esi + 0x58]
    result = *((int*)(memory_access));
    // 0x1733: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    // 0x1735: je 
    // Assembly: je 0x1751
    if (zero_flag) goto label_1751;
    // 0x1737: mov 
    // Assembly: mov ecx, dword ptr [esi + 0x54]
    counter = *((int*)(memory_access));
    // 0x173a: test 
    // Assembly: test ecx, ecx
    // Compare: counter vs counter
...
int text_x86_000017c0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x17c3: movzx 
    // Assembly: movzx eax, word ptr [ebp + 8]
    ...
    // Push result to stack
    // 0x17d4: call 
    // Assembly: call dword ptr [0x4a979c]
    result = function_ptr();
    // 0x17da: push 
    // Assembly: push eax
    // Push result to stack
...
int text_x86_00001840(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    src_ptr = counter;
    // 0x185c: mov 
    // Assembly: mov dword ptr [ebp - 0x10], esi
    *((int*)(memory_access)) = src_ptr;
    // 0x185f: mov 
    // Assembly: mov dword ptr [esi], 0x4a9e20
    memory_access = 0x4a9e20;
    // 0x1865: lea 
    // Assembly: lea ecx, [esi + 0x88]
    // lea ecx, [esi + 0x88]
    // 0x186b: mov 
    // Assembly: mov dword ptr [ebp - 4], 3
    memory_access = 3;
}
...
int text_x86_000018e0(void)
{
    ...
    // 0x18e6: mov 
    // Assembly: mov eax, dword ptr [ebp + 0x14]
    result = *((int*)(memory_access));
    // 0x18e9: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    src_ptr = counter;
    // 0x18ec: mov 
    // Assembly: mov ecx, dword ptr [ebp + 0x24]
    counter = *((int*)(memory_access));
    // 0x18ef: mov 
    // Assembly: mov dword ptr [esi + 0x54], eax
    *((int*)(memory_access)) = result;
    // 0x18f2: movzx 
    // Assembly: movzx eax, word ptr [ebp + 0x18]
    ...
    // Push result to stack
    // 0x18fb: mov 
    // Assembly: mov dword ptr [esi + 0x58], ecx
    *((int*)(memory_access)) = counter;
    // 0x18fe: mov 
    // Assembly: mov dword ptr [esi + 0x6c], 0
    memory_access = 0;
    // 0x1905: call 
    // Assembly: call 0x8b892
    result = func_8b892();
    // 0x190a: mov 
    // Assembly: mov edi, dword ptr [0x4a979c]
}
...
int text_x86_00001a00(void)
{
    ...
    // Push temp1 to stack
    // 0x1a07: mov 
    // Assembly: mov ebx, dword ptr [0x4a979c]
    ...
    src_ptr = counter;
    // 0x1a10: mov 
    // Assembly: mov ecx, dword ptr [esi + 0x5c]
    counter = *((int*)(memory_access));
    // 0x1a13: mov 
    // Assembly: mov dword ptr [esi + 0x58], eax
    *((int*)(memory_access)) = result;
    // 0x1a16: cmp 
    // Assembly: cmp ecx, dword ptr [ebp + 8]
    // Compare: counter vs dword ptr [ebp + 8]
    // 0x1a19: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    // 0x1a1a: je 
    // Assembly: je 0x1a46
    if (zero_flag) goto label_1a46;
    // 0x1a1c: lea 
...
int text_x86_00001b00(void)
{
    ...
    // fld dword ptr [ecx]
    // 0x1b0c: mov 
    // Assembly: mov eax, dword ptr [esi + 0x6c]
    result = *((int*)(memory_access));
    // 0x1b0f: fadd 
    // Assembly: fadd dword ptr [esi + 0x6c]
    // fadd dword ptr [esi + 0x6c]
    // 0x1b12: mov 
    // Assembly: mov dword ptr [ebp - 4], eax
    *((int*)(memory_access)) = result;
    // 0x1b15: push 
    ...
    temp2 = *((int*)(memory_access));
    // 0x1b25: fcomp 
    // Assembly: fcomp dword ptr [0x4a9acc]
    // fcomp dword ptr [0x4a9acc]
    // 0x1b2b: mov 
    // Assembly: mov dword ptr [esi + 0x6c], edx
}
...
int text_x86_00001b80(void)
{
    ...
    // 0x1b86: mov 
    // Assembly: mov eax, dword ptr [ecx + 0x60]
    result = *((int*)(memory_access));
    // 0x1b89: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    ...
    // 0x1b91: je 
    // Assembly: je 0x1ba6
    if (zero_flag) goto label_1ba6;
    // 0x1b93: fld 
    // Assembly: fld dword ptr [ecx + 0x6c]
    // fld dword ptr [ecx + 0x6c]
    // 0x1b96: fcomp 
    // Assembly: fcomp dword ptr [0x4a9ad0]
    // fcomp dword ptr [0x4a9ad0]
    // 0x1b9c: fnstsw 
    // Assembly: fnstsw ax
    // fnstsw ax
    // 0x1b9e: test 
...
int text_x86_00001c60(void)
{
    ...
    // Push result to stack
    // 0x1c75: mov 
    // Assembly: mov dword ptr [ebp - 4], 0xe
    memory_access = 0xe;
    // 0x1c7c: call 
    // Assembly: call 0x5a20
    result = func_5a20();
...
int text_x86_00001d70(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    // 0x1d8f: mov 
    // Assembly: mov dword ptr [esi], 0x4a9fd8
    memory_access = 0x4a9fd8;
    // 0x1d95: lea 
    // Assembly: lea ecx, [esi + 0x74]
    // lea ecx, [esi + 0x74]
    // 0x1d98: mov 
    // Assembly: mov dword ptr [ebp - 4], 1
    memory_access = 1;
}
...
int text_x86_00001de0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0x1dfb: mov 
    // Assembly: mov eax, dword ptr [ebp + 0x18]
    result = *((int*)(memory_access));
    // 0x1dfe: mov 
    // Assembly: mov edx, dword ptr [ebp + 0x20]
    temp2 = *((int*)(memory_access));
    // 0x1e01: push 
    // Assembly: push ebx
    // Push temp1 to stack
    // 0x1e02: mov 
    // Assembly: mov ebx, dword ptr [ebp + 0xc]
    temp1 = *((int*)(memory_access));
    // 0x1e05: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    src_ptr = counter;
    // 0x1e08: mov 
    // Assembly: mov ecx, dword ptr [ebp + 0x1c]
    counter = *((int*)(memory_access));
    // 0x1e0b: push 
    // Assembly: push edi
    // Push dst_ptr to stack
...
int text_x64_00001fc4(void)
{
    ...
    // 0x1fd6: mov 
    // Assembly: mov ecx, dword ptr [ebp - 0xc]
    counter = *((int*)(memory_access));
    // 0x1fd9: mov 
    // Assembly: mov dword ptr fs:[0], ecx
    *((int*)(memory_access)) = counter;
    // 0x1fe0: mov 
    // Assembly: mov esp, ebp
    stack_ptr = frame_ptr;
...
int text_x86_00002020(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    temp1 = counter;
    // 0x2040: mov 
    // Assembly: mov ecx, dword ptr [ebx + 0x20]
    counter = *((int*)(memory_access));
    // 0x2043: lea 
    ...
    // Push counter to stack
    // 0x2048: call 
    // Assembly: call dword ptr [0x4a9790]
}
...
int text_x86_00002180(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push src_ptr to stack
    // 0x219d: mov 
    // Assembly: mov esi, dword ptr [ebp + 8]
    ...
    dst_ptr = counter;
    // 0x21a3: test 
    // Assembly: test byte ptr [edi + 0x58], 1
    // Compare: byte ptr [edi + 0x58] vs 1
    // 0x21a7: je 
    // Assembly: je 0x2205
    if (zero_flag) goto label_2205;
    // 0x21a9: mov 
    // Assembly: mov eax, dword ptr [esi + 0x18]
    result = *((int*)(memory_access));
    // 0x21ac: push 
    // Assembly: push eax
}
...
int text_func_1200(void)
{
    ...
    // adc eax, 0x4a9050
    // 0x2205: test 
    // Assembly: test byte ptr [edi + 0x58], 2
    // Compare: byte ptr [edi + 0x58] vs 2
    // 0x2209: je 
    // Assembly: je 0x2332
    if (zero_flag) goto label_2332;
    // 0x220f: lea 
    ...
    // Push result to stack
    // 0x2217: call 
    // Assembly: call dword ptr [0x4a9798]
    result = function_ptr();
    // 0x221d: mov 
    // Assembly: mov eax, dword ptr [ebp - 0x28]
    result = *((int*)(memory_access));
    // 0x2220: mov 
    // Assembly: mov ecx, dword ptr [edi + 0x64]
    counter = *((int*)(memory_access));
    // 0x2223: mov 
    // Assembly: mov edx, dword ptr [ebp - 0x24]
    temp2 = *((int*)(memory_access));
    // 0x2226: add 
    // Assembly: add eax, 2
    result = result + 2;
    // 0x2229: mov 
    // Assembly: mov dword ptr [ebp - 0x28], eax
    *((int*)(memory_access)) = result;
    // 0x222c: add 
    // Assembly: add eax, ecx
    result = result + counter;
    // 0x222e: mov 
    // Assembly: mov ecx, dword ptr [ebp - 0x20]
    counter = *((int*)(memory_access));
    // 0x2231: dec 
    // Assembly: dec edx
    // dec edx
...
int text_x86_00002380(void)
{
    ...
    src_ptr = counter;
    // 0x2386: test 
    // Assembly: test byte ptr [esi + 0x58], 2
    // Compare: byte ptr [esi + 0x58] vs 2
    // 0x238a: jne 
    // Assembly: jne 0x23bf
    if (!zero_flag) goto label_23bf;
    // 0x238c: push 
    ...
    // Push 0x20 to stack
    // 0x2393: mov 
    // Assembly: mov eax, dword ptr [esi + 0x60]
    result = *((int*)(memory_access));
    // 0x2396: push 
    // Assembly: push 0
    // Push 0 to stack
...
int text_x86_00002400(void)
{
    ...
    // Push temp1 to stack
    // 0x2404: mov 
    // Assembly: mov ebx, dword ptr [ebp + 8]
    temp1 = *((int*)(memory_access));
    // 0x2407: test 
...
int text_x86_00002550(void)
{
    ...
    counter = counter + 4;
    // 0x255a: mov 
    // Assembly: mov edx, dword ptr [ecx]
    temp2 = *((int*)(memory_access));
    // 0x255c: sub 
    // Assembly: sub esp, 0x10
    stack_ptr = stack_ptr - 16;
    ...
    result = stack_ptr;
    // 0x2561: mov 
    // Assembly: mov dword ptr [eax], edx
    *((int*)(memory_access)) = temp2;
    // 0x2563: mov 
    // Assembly: mov edx, dword ptr [ecx + 4]
    temp2 = *((int*)(memory_access));
    // 0x2566: mov 
    // Assembly: mov dword ptr [eax + 4], edx
    *((int*)(memory_access)) = temp2;
    // 0x2569: mov 
    // Assembly: mov edx, dword ptr [ecx + 8]
    temp2 = *((int*)(memory_access));
    // 0x256c: mov 
    // Assembly: mov ecx, dword ptr [ecx + 0xc]
    counter = *((int*)(memory_access));
    // 0x256f: mov 
    // Assembly: mov dword ptr [eax + 8], edx
    *((int*)(memory_access)) = temp2;
    // 0x2572: mov 
    // Assembly: mov edx, dword ptr [ebp + 0xc]
    temp2 = *((int*)(memory_access));
...
int text_x86_00002590(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x2593: mov 
    // Assembly: mov ecx, dword ptr [ebp + 0x10]
    counter = *((int*)(memory_access));
    // 0x2596: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x2597: mov 
    // Assembly: mov esi, dword ptr [ebp + 0xc]
    src_ptr = *((int*)(memory_access));
    // 0x259a: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    // 0x259b: mov 
    // Assembly: mov edi, dword ptr [ebp + 8]
    dst_ptr = *((int*)(memory_access));
    // 0x259e: lea 
    ...
    // Push dst_ptr to stack
    // 0x25a5: call 
    // Assembly: call dword ptr [0x4a96f0]
    result = function_ptr();
    // 0x25ab: add 
    ...
    // 0x25b0: jge 
    // Assembly: jge 0x25b9
    if (jge_condition) goto label_25b9;
    // 0x25b2: lea 
...
int text_x86_000026b0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x26b3: fld 
    // Assembly: fld dword ptr [ecx + 0x10]
    // fld dword ptr [ecx + 0x10]
    // 0x26b6: mov 
    // Assembly: mov eax, dword ptr [ecx + 4]
    result = *((int*)(memory_access));
    // 0x26b9: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    // 0x26c0: fstp 
    // Assembly: fstp qword ptr [esp + 0x10]
    // fstp qword ptr [esp + 0x10]
    // 0x26c4: fld 
    // Assembly: fld dword ptr [ecx + 0xc]
    // fld dword ptr [ecx + 0xc]
    // 0x26c7: fstp 
    // Assembly: fstp qword ptr [esp + 8]
    // fstp qword ptr [esp + 8]
    // 0x26cb: fld 
    // Assembly: fld dword ptr [ecx + 8]
    // fld dword ptr [ecx + 8]
    // 0x26ce: mov 
    // Assembly: mov ecx, dword ptr [ebp + 0xc]
    counter = *((int*)(memory_access));
    // 0x26d1: fstp 
    // Assembly: fstp qword ptr [esp]
    // fstp qword ptr [esp]
    // 0x26d4: push 
    // Assembly: push eax
    // Push result to stack
...
int text_x86_00002730(void)
{
    ...
    temp2 = *((int*)(memory_access));
    // 0x2738: cmp 
    // Assembly: cmp edx, dword ptr [eax]
    // Compare: temp2 vs dword ptr [eax]
    // 0x273a: jne 
    // Assembly: jne 0x275d
    if (!zero_flag) goto label_275d;
    // 0x273c: mov 
    // Assembly: mov dl, byte ptr [ecx + 4]
    result = memory_access;
    // 0x273f: cmp 
    // Assembly: cmp dl, byte ptr [eax + 4]
    // Compare: dl vs byte ptr [eax + 4]
    // 0x2742: jne 
    // Assembly: jne 0x275d
    if (!zero_flag) goto label_275d;
    // 0x2744: mov 
    // Assembly: mov dl, byte ptr [ecx + 5]
    result = memory_access;
    // 0x2747: cmp 
    // Assembly: cmp dl, byte ptr [eax + 5]
    // Compare: dl vs byte ptr [eax + 5]
    // 0x274a: jne 
    // Assembly: jne 0x275d
    if (!zero_flag) goto label_275d;
    // 0x274c: mov 
    // Assembly: mov cl, byte ptr [ecx + 6]
    result = memory_access;
    // 0x274f: cmp 
    // Assembly: cmp cl, byte ptr [eax + 6]
    // Compare: cl vs byte ptr [eax + 6]
    // 0x2752: jne 
    // Assembly: jne 0x275d
    if (!zero_flag) goto label_275d;
    // 0x2754: mov 
...
int text_x86_00002770(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x2773: movzx 
    // Assembly: movzx eax, byte ptr [ecx + 0xe]
    // movzx eax, byte ptr [ecx + 0xe]
    // 0x2777: movzx 
    // Assembly: movzx edx, byte ptr [ecx + 0xd]
    // movzx edx, byte ptr [ecx + 0xd]
    // 0x277b: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x277c: mov 
    ...
    // Push result to stack
    // 0x2780: movzx 
    // Assembly: movzx eax, byte ptr [ecx + 0xc]
    // movzx eax, byte ptr [ecx + 0xc]
    // 0x2784: push 
    // Assembly: push edx
    // Push temp2 to stack
    // 0x2785: mov 
...
int text_x86_000027d0(void)
{
    ...
    result = *((int*)(memory_access));
    // 0x27d6: mov 
    // Assembly: mov dl, byte ptr [ecx]
    result = memory_access;
    // 0x27d8: cmp 
    // Assembly: cmp dl, byte ptr [eax]
    // Compare: dl vs byte ptr [eax]
    // 0x27da: jne 
    // Assembly: jne 0x2805
    if (!zero_flag) goto label_2805;
    // 0x27dc: mov 
    // Assembly: mov edx, dword ptr [ecx + 1]
    temp2 = *((int*)(memory_access));
    // 0x27df: cmp 
    // Assembly: cmp edx, dword ptr [eax + 1]
    // Compare: temp2 vs dword ptr [eax + 1]
    // 0x27e2: jne 
    // Assembly: jne 0x2805
    if (!zero_flag) goto label_2805;
    // 0x27e4: mov 
    // Assembly: mov edx, dword ptr [ecx + 5]
    temp2 = *((int*)(memory_access));
    // 0x27e7: cmp 
    // Assembly: cmp edx, dword ptr [eax + 5]
    // Compare: temp2 vs dword ptr [eax + 5]
    // 0x27ea: jne 
    // Assembly: jne 0x2805
    if (!zero_flag) goto label_2805;
    // 0x27ec: mov 
    // Assembly: mov edx, dword ptr [ecx + 9]
    temp2 = *((int*)(memory_access));
    // 0x27ef: cmp 
    // Assembly: cmp edx, dword ptr [eax + 9]
    // Compare: temp2 vs dword ptr [eax + 9]
    // 0x27f2: jne 
    // Assembly: jne 0x2805
    if (!zero_flag) goto label_2805;
    // 0x27f4: mov 
    // Assembly: mov ecx, dword ptr [ecx + 0xd]
    counter = *((int*)(memory_access));
    // 0x27f7: cmp 
    // Assembly: cmp ecx, dword ptr [eax + 0xd]
}
...
int text_x86_00002810(void)
{
    ...
    // lea eax, [ecx + 5]
    // 0x281a: mov 
    // Assembly: mov esi, dword ptr [eax]
    src_ptr = *((int*)(memory_access));
    // 0x281c: movzx 
    // Assembly: movzx ecx, byte ptr [ecx + 4]
    // movzx ecx, byte ptr [ecx + 4]
    // 0x2820: mov 
    // Assembly: mov edx, esp
    temp2 = stack_ptr;
    // 0x2822: mov 
    // Assembly: mov dword ptr [edx], esi
    *((int*)(memory_access)) = src_ptr;
    // 0x2824: mov 
    // Assembly: mov esi, dword ptr [eax + 4]
    src_ptr = *((int*)(memory_access));
    // 0x2827: mov 
    // Assembly: mov dword ptr [edx + 4], esi
    *((int*)(memory_access)) = src_ptr;
    // 0x282a: mov 
    // Assembly: mov esi, dword ptr [eax + 8]
    src_ptr = *((int*)(memory_access));
    // 0x282d: mov 
    // Assembly: mov eax, dword ptr [eax + 0xc]
    result = *((int*)(memory_access));
    // 0x2830: mov 
    // Assembly: mov dword ptr [edx + 8], esi
    *((int*)(memory_access)) = src_ptr;
    // 0x2833: mov 
    // Assembly: mov esi, dword ptr [ebp + 8]
    src_ptr = *((int*)(memory_access));
    ...
    // Push counter to stack
    // 0x2837: mov 
    // Assembly: mov dword ptr [edx + 0xc], eax
}
...
int text_x86_00002870(void)
{
    ...
    // Push counter to stack
    // 0x2874: call 
    // Assembly: call dword ptr [0x4a96e8]
    result = function_ptr();
    // 0x287a: mov 
    // Assembly: mov dword ptr [ebp - 4], eax
    *((int*)(memory_access)) = result;
    // 0x287d: fild 
    // Assembly: fild dword ptr [ebp - 4]
    // fild dword ptr [ebp - 4]
    // 0x2880: fstp 
    // Assembly: fstp dword ptr [ebp - 4]
    // fstp dword ptr [ebp - 4]
    // 0x2883: fld 
    // Assembly: fld dword ptr [ebp - 4]
    // fld dword ptr [ebp - 4]
    // 0x2886: fdiv 
    // Assembly: fdiv dword ptr [0x4aadf4]
    // fdiv dword ptr [0x4aadf4]
    // 0x288c: fld 
    // Assembly: fld dword ptr [ebp + 0xc]
    // fld dword ptr [ebp + 0xc]
    // 0x288f: fsub 
    // Assembly: fsub dword ptr [ebp + 8]
    // fsub dword ptr [ebp + 8]
    // 0x2892: fmulp 
    // Assembly: fmulp st(1)
    // fmulp st(1)
    // 0x2894: fadd 
    // Assembly: fadd dword ptr [ebp + 8]
...
int text_func_1900(void)
{
    ...
    // Converted from assembly instructions:
    // 0x2900: mov 
    // Assembly: mov edx, dword ptr [esi + 0x294]
    temp2 = *((int*)(memory_access));
    // 0x2906: lea 
    // Assembly: lea ecx, [esi + 0x294]
    // lea ecx, [esi + 0x294]
    // 0x290c: call 
    // Assembly: call dword ptr [edx + 0x68]
    result = function_ptr();
    // 0x290f: mov 
    // Assembly: mov eax, dword ptr [esi + 0x324]
    result = *((int*)(memory_access));
    // 0x2915: lea 
    // Assembly: lea ecx, [esi + 0x324]
    // lea ecx, [esi + 0x324]
    // 0x291b: call 
    // Assembly: call dword ptr [eax + 0x68]
    result = function_ptr();
    // 0x291e: mov 
    // Assembly: mov edx, dword ptr [esi + 0x3b4]
    temp2 = *((int*)(memory_access));
    // 0x2924: lea 
    ...
    result = function_ptr();
    // 0x292d: mov 
    // Assembly: mov eax, dword ptr [esi + 0x444]
    result = *((int*)(memory_access));
    // 0x2933: lea 
    ...
    result = function_ptr();
    // 0x293c: mov 
    // Assembly: mov edx, dword ptr [esi + 0x4d4]
    temp2 = *((int*)(memory_access));
    // 0x2942: lea 
    ...
    result = function_ptr();
    // 0x294b: mov 
    // Assembly: mov eax, dword ptr [esi + 0x564]
    result = *((int*)(memory_access));
    // 0x2951: lea 
...
int text_x86_00002a20(void)
{
    ...
    // 0x2a2b: ja 
    // Assembly: ja 0x2b7b
    if (ja_condition) goto label_2b7b;
    // 0x2a31: jmp 
    // Assembly: jmp dword ptr [eax*4 + 0x402b80]
    // jmp dword ptr [eax*4 + 0x402b80]
    // 0x2a38: call 
    ...
    // Push 0xf3 to stack
    // 0x2a4b: call 
    // Assembly: call dword ptr [0x4a97e8]
    result = function_ptr();
    // 0x2a51: pop 
    // Assembly: pop ebp
    // Pop from stack to frame_ptr
...
int text_x86_00002ba0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x2ba3: cmp 
    // Assembly: cmp dword ptr [ebp + 8], 0x103
    // Compare: dword ptr [ebp + 8] vs 0x103
    // 0x2baa: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x2bab: mov 
    ...
    // 0x2bad: jne 
    // Assembly: jne 0x2be2
    if (!zero_flag) goto label_2be2;
    // 0x2baf: mov 
    // Assembly: mov eax, dword ptr [esi + 0xa94]
    result = *((int*)(memory_access));
    // 0x2bb5: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    ...
    if (zero_flag) goto label_2be2;
    // 0x2bb9: mov 
    // Assembly: mov al, byte ptr [esi + 0x18]
    result = memory_access;
    // 0x2bbc: test 
    // Assembly: test al, al
    // Compare: al vs al
    ...
    if (!zero_flag) goto label_2be2;
    // 0x2bc0: mov 
    // Assembly: mov ecx, dword ptr [esi + 0xa94]
    counter = *((int*)(memory_access));
    // 0x2bc6: mov 
    // Assembly: mov eax, dword ptr [ecx]
    result = *((int*)(memory_access));
    ...
    // Push 5 to stack
    // 0x2bca: call 
    // Assembly: call dword ptr [eax + 0x14]
    result = function_ptr();
    // 0x2bcd: push 
    // Assembly: push eax
}
...
int text_x86_00002bf0(void)
{
    ...
    src_ptr = counter;
    // 0x2bfd: call 
    // Assembly: call dword ptr [0x4a9758]
    result = function_ptr();
    // 0x2c03: push 
    // Assembly: push 1
    // Push 1 to stack
    // 0x2c05: call 
    // Assembly: call dword ptr [0x4a975c]
    result = function_ptr();
    // 0x2c0b: test 
    // Assembly: test ah, ah
    // Compare: ah vs ah
    // 0x2c0d: jns 
    // Assembly: jns 0x2cf4
    if (jns_condition) goto label_2cf4;
    // 0x2c13: push 
    // Assembly: push ebx
    // Push temp1 to stack
    // 0x2c14: mov 
    // Assembly: mov ebx, dword ptr [0x4a9790]
    temp1 = *((int*)(memory_access));
    // 0x2c1a: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    // 0x2c1b: mov 
    // Assembly: mov edi, dword ptr [0x4a977c]
    dst_ptr = *((int*)(memory_access));
}
...
int text_x86_00002d40(void)
{
    ...
    dst_ptr = counter;
    // 0x2d49: mov 
    // Assembly: mov eax, dword ptr [edi + 0x74]
    result = *((int*)(memory_access));
    // 0x2d4c: sub 
    // Assembly: sub eax, 0
    result = result - 0;
    ...
    temp1 = *((int*)(memory_access));
    // 0x2d58: mov 
    // Assembly: mov eax, dword ptr [ebx + 4]
    result = *((int*)(memory_access));
    // 0x2d5b: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    // Push result to stack
    // 0x2d5d: call 
    // Assembly: call dword ptr [0x4a904c]
    result = function_ptr();
    // 0x2d63: mov 
    // Assembly: mov ecx, dword ptr [edi + 0xe0]
}
...
int text_x86_00002dd0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0x2deb: mov 
    // Assembly: mov eax, dword ptr [0x4d23b4]
    result = *((int*)(memory_access));
    // 0x2df0: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    *((int*)(memory_access)) = result;
    ...
    result = func_8b964();
    // 0x2dff: mov 
    // Assembly: mov eax, dword ptr [esi + 0x74]
    result = *((int*)(memory_access));
}
...
int text_x86_00002ec0(void)
{
    ...
    dst_ptr = result;
    // 0x2edd: mov 
    // Assembly: mov eax, dword ptr [edi + 0x2c]
    result = *((int*)(memory_access));
    // 0x2ee0: push 
    // Assembly: push eax
    // Push result to stack
    // 0x2ee1: mov 
    // Assembly: mov dword ptr [edi + 0x28], 1
    memory_access = 1;
    // 0x2ee8: call 
    // Assembly: call dword ptr [0x4a9178]
}
...
int text_func_1f00(void)
{
    ...
    // 0x2f00: je 
    // Assembly: je 0x2e93
    if (zero_flag) goto label_2e93;
    // 0x2f02: dec 
    // Assembly: dec edx
    // dec edx
    // 0x2f03: add 
    // Assembly: add byte ptr [ebx - 0x3f7ab7b9], cl
    // add byte ptr [ebx - 0x3f7ab7b9], cl
    // 0x2f09: je 
    // Assembly: je 0x2ef5
    if (zero_flag) goto label_2ef5;
    // 0x2f0b: mov 
    // Assembly: mov al, byte ptr [edi + 0x44]
    result = memory_access;
    // 0x2f0e: test 
    // Assembly: test al, al
    // Compare: al vs al
    // 0x2f10: mov 
    // Assembly: mov esi, dword ptr [0x4a97c8]
    src_ptr = *((int*)(memory_access));
    // 0x2f16: mov 
    // Assembly: mov ebx, dword ptr [0x4a9764]
    temp1 = *((int*)(memory_access));
    // 0x2f1c: jne 
    // Assembly: jne 0x2fa9
    if (!zero_flag) goto label_2fa9;
    // 0x2f22: mov 
    // Assembly: mov ecx, dword ptr [edi + 0x48]
    counter = *((int*)(memory_access));
    // 0x2f25: mov 
    // Assembly: mov al, byte ptr [ecx + 0x68]
    result = memory_access;
    // 0x2f28: test 
    // Assembly: test al, al
    // Compare: al vs al
    ...
    // Push 0xa to stack
    // 0x2f32: call 
    // Assembly: call dword ptr [0x4a9174]
    result = function_ptr();
    // 0x2f38: mov 
}
...
int text_x86_00003020(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    counter = src_ptr;
    // 0x3042: mov 
    // Assembly: mov dword ptr [ebp - 0x10], edi
    *((int*)(memory_access)) = dst_ptr;
    // 0x3045: call 
    // Assembly: call dword ptr [0x4a91ec]
    result = function_ptr();
    // 0x304b: push 
    // Assembly: push eax
    // Push result to stack
...
int text_x86_000030d0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push counter to stack
    // 0x30e9: mov 
    // Assembly: mov eax, dword ptr [ebp + 0x10]
    result = *((int*)(memory_access));
    // 0x30ec: push 
    // Assembly: push esi
    // Push src_ptr to stack
...
int text_x86_00003140(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    // 0x315f: mov 
    // Assembly: mov dword ptr [esi], 0x4aae04
    memory_access = 0x4aae04;
    // 0x3165: mov 
    // Assembly: mov eax, dword ptr [esi + 0xc]
    result = *((int*)(memory_access));
    // 0x3168: push 
    // Assembly: push esi
    // Push src_ptr to stack
...
int text_x86_000031b0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x31b3: mov 
    // Assembly: mov eax, dword ptr [ecx + 0xc]
    result = *((int*)(memory_access));
    // 0x31b6: mov 
    // Assembly: mov ecx, dword ptr [ebp + 8]
    counter = *((int*)(memory_access));
    // 0x31b9: mov 
    // Assembly: mov dword ptr [eax], ecx
    *((int*)(memory_access)) = counter;
    // 0x31bb: pop 
    // Assembly: pop ebp
    // Pop from stack to frame_ptr
...
int text_x86_00003210(void)
{
    ...
    // 0x3219: je 
    // Assembly: je 0x3254
    if (zero_flag) goto label_3254;
    // 0x321b: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x321c: call 
    // Assembly: call dword ptr [0x4a9704]
    result = function_ptr();
    // 0x3222: add 
    // Assembly: add esp, 4
    stack_ptr = stack_ptr + 4;
    ...
    // Push result to stack
    // 0x3228: mov 
    // Assembly: mov dword ptr [ebp + 8], 0x4d3d4c
    ...
    // Push result to stack
    // 0x3233: call 
    // Assembly: call dword ptr [0x4a9190]
    result = function_ptr();
    // 0x3239: mov 
    // Assembly: mov dword ptr [ebp + 8], 0x4d3d50
...
int text_x86_00003260(void)
{
    ...
    src_ptr = *((int*)(memory_access));
    // 0x3268: mov 
    // Assembly: mov dword ptr [ebp - 4], 0x4d3d4c
    memory_access = 0x4d3d4c;
    // 0x326f: mov 
    // Assembly: mov eax, dword ptr [ebp - 4]
    result = *((int*)(memory_access));
    // 0x3272: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    result = function_ptr();
    // 0x327a: mov 
    // Assembly: mov dword ptr [ebp - 4], 0x4d3d50
    memory_access = 0x4d3d50;
    // 0x3281: mov 
    // Assembly: mov ecx, dword ptr [ebp - 4]
    counter = *((int*)(memory_access));
    // 0x3284: push 
    // Assembly: push ecx
    // Push counter to stack
    // 0x3285: call 
    // Assembly: call dword ptr [0x4a9198]
    result = function_ptr();
    // 0x328b: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x328c: call 
    // Assembly: call dword ptr [0x4a970c]
    result = function_ptr();
}
...
int text_x86_000032a0(void)
{
    ...
    // Push result to stack
    // 0x32aa: call 
    // Assembly: call dword ptr [0x4a91a0]
    result = function_ptr();
    // 0x32b0: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    // 0x32b2: je 
    // Assembly: je 0x32ff
    if (zero_flag) goto label_32ff;
    // 0x32b4: mov 
    // Assembly: mov eax, dword ptr [0x4d26d8]
    result = *((int*)(memory_access));
    // 0x32b9: push 
    // Assembly: push ebx
    // Push temp1 to stack
    ...
    // Push dst_ptr to stack
    // 0x32bc: mov 
    // Assembly: mov edi, dword ptr [0x4c84a4]
    dst_ptr = *((int*)(memory_access));
    // 0x32c2: xor 
    ...
    // Compare: dst_ptr vs dst_ptr
    // 0x32c6: mov 
    // Assembly: mov dword ptr [ebp - 4], 0x11
}
...
int text_template_0000334d(void)
{
    ...
    // 0x3355: jle 
    // Assembly: jle 0x335c
    if (jle_condition) goto label_335c;
    // 0x3357: mov 
    ...
    // 0x336a: je 
    // Assembly: je 0x32fc
    if (zero_flag) goto label_32fc;
    // 0x336c: cmp 
    // Assembly: cmp esi, 0x14
    // Compare: src_ptr vs 0x14
    // 0x336f: jg 
    // Assembly: jg 0x3378
    if (greater_than) goto label_3378;
    // 0x3371: push 
    // Assembly: push 0
    // Push 0 to stack
    // 0x3373: call 
...
int text_x86_00003390(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    ...
    result = func_8b808();
    // 0x33b5: mov 
    // Assembly: mov dword ptr [esi + 0x54], 0x4aadf8
    memory_access = 0x4aadf8;
    // 0x33bc: mov 
    // Assembly: mov dword ptr [esi], 0x4aae28
...
int text_func_2400(void)
{
    ...
    // loopne 0x3402
    // 0x3402: add 
    // Assembly: add byte ptr [eax], al
    // add byte ptr [eax], al
    // 0x3404: mov 
    // Assembly: mov dword ptr [esi + 0xdc], 0x4a9e0c
    memory_access = 0x4a9e0c;
    // 0x340e: lea 
    // Assembly: lea ecx, [esi + 0xe4]
    // lea ecx, [esi + 0xe4]
    // 0x3414: mov 
    // Assembly: mov byte ptr [ebp - 4], 4
    memory_access = 4;
    // 0x3418: call 
...
int text_x86_00003590(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    ...
    memory_access = 0x4aae28;
    // 0x35b5: mov 
    // Assembly: mov dword ptr [esi + 0x54], 0x4aae24
...
int text_func_2600(void)
{
    ...
    // lea ecx, [esi + 0x8f0]
    // 0x360a: mov 
    // Assembly: mov byte ptr [ebp - 4], 0x13
    memory_access = 0x13;
    // 0x360e: call 
    // Assembly: call 0x1020
    result = func_1020();
    ...
    // lea ecx, [esi + 0x874]
    // 0x3619: mov 
    // Assembly: mov byte ptr [ebp - 4], 0x12
    memory_access = 0x12;
    // 0x361d: call 
    ...
    // lea ecx, [esi + 0x7f8]
    // 0x3628: mov 
    // Assembly: mov byte ptr [ebp - 4], 0x11
    memory_access = 0x11;
    // 0x362c: call 
    // Assembly: call 0xc8e0
    result = func_c8e0();
    ...
    // lea ecx, [esi + 0x774]
    // 0x3637: mov 
    // Assembly: mov byte ptr [ebp - 4], 0x10
    memory_access = 0x10;
    // 0x363b: call 
    // Assembly: call 0x1d70
    result = func_1d70();
    ...
    // lea ecx, [esi + 0x6f0]
    // 0x3646: mov 
    // Assembly: mov byte ptr [ebp - 4], 0xf
}
...
int text_x86_00003750(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push src_ptr to stack
    // 0x376b: mov 
    // Assembly: mov dword ptr [ebp - 0x10], 0x4d3d4c
    memory_access = 0x4d3d4c;
    // 0x3772: mov 
    // Assembly: mov eax, dword ptr [ebp - 0x10]
    result = *((int*)(memory_access));
...
int text_x86_000037f0(void)
{
    ...
    *((int*)(memory_access)) = counter;
    ...
    frame_ptr = stack_ptr;
    // 0x3803: mov 
    // Assembly: mov eax, dword ptr [ebp + 0xc]
    result = *((int*)(memory_access));
    // 0x3806: mov 
    // Assembly: mov ecx, dword ptr [eax]
    counter = *((int*)(memory_access));
    // 0x3808: mov 
    // Assembly: mov eax, dword ptr [0x4d2728]
    result = *((int*)(memory_access));
    // 0x380d: push 
    // Assembly: push ebx
    // Push temp1 to stack
...
int text_x86_00003960(void)
{
    ...
    // int3 
    // 0x3980: mov 
    // Assembly: mov dword ptr [ecx], 0x4aabb0
...
int text_x86_00003990(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push counter to stack
    // 0x39a9: mov 
    // Assembly: mov eax, dword ptr [0x4d3d6c]
    result = *((int*)(memory_access));
    // 0x39ae: push 
    // Assembly: push ebx
    // Push temp1 to stack
    ...
    // Compare: counter vs counter
    // 0x39b6: mov 
    // Assembly: mov dword ptr [0x4d3d6c], eax
    *((int*)(memory_access)) = result;
    // 0x39bb: jne 
    // Assembly: jne 0x3a42
    if (!zero_flag) goto label_3a42;
    // 0x39c1: push 
    // Assembly: push esi
}
...
int text_x86_00003b60(void)
{
    ...
    result = func_32a0();
    // 0x3b7e: mov 
    // Assembly: mov ecx, dword ptr [esi]
    counter = *((int*)(memory_access));
    // 0x3b80: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
    ...
    *((int*)(memory_access)) = counter;
    ...
    stack_ptr = stack_ptr + 4;
    // 0x3b88: mov 
    // Assembly: mov dword ptr [esi], eax
    *((int*)(memory_access)) = result;
}
...
int text_x86_00003bd0(void)
{
    ...
    // 0x3bde: jbe 
    // Assembly: jbe 0x3c0f
    if (jbe_condition) goto label_3c0f;
    // 0x3be0: mov 
    // Assembly: mov dword ptr [ebp + 8], 0x4d3d4c
    memory_access = 0x4d3d4c;
    // 0x3be7: mov 
...
int text_x86_00003c20(void)
{
    ...
    // 0x3c2b: jbe 
    // Assembly: jbe 0x3c3b
    if (jbe_condition) goto label_3c3b;
    // 0x3c2d: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
    // 0x3c30: push 
...
int text_x86_00003c50(void)
{
    ...
    // 0x3c5d: ja 
    // Assembly: ja 0x3c7c
    if (ja_condition) goto label_3c7c;
    // 0x3c5f: test 
    // Assembly: test edi, edi
    // Compare: dst_ptr vs dst_ptr
    // 0x3c61: jbe 
    // Assembly: jbe 0x3c7c
    if (jbe_condition) goto label_3c7c;
    // 0x3c63: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    // 0x3c64: call 
    ...
    *((int*)(memory_access)) = result;
    // 0x3c6e: mov 
    // Assembly: mov dword ptr [esi + 4], eax
    *((int*)(memory_access)) = result;
    // 0x3c71: add 
...
int text_x86_00003c90(void)
{
    ...
    // Push dst_ptr to stack
    // 0x3c96: mov 
    // Assembly: mov edi, dword ptr [ebp + 0xc]
    dst_ptr = *((int*)(memory_access));
    // 0x3c99: mov 
    // Assembly: mov esi, ecx
    src_ptr = counter;
    // 0x3c9b: sub 
    // Assembly: sub edi, dword ptr [ebp + 8]
    dst_ptr = dst_ptr - dword ptr [ebp + 8];
    // 0x3c9e: lea 
    ...
    // 0x3ca4: ja 
    // Assembly: ja 0x3cbf
    if (ja_condition) goto label_3cbf;
    // 0x3ca6: test 
    // Assembly: test ebx, ebx
    // Compare: temp1 vs temp1
    // 0x3ca8: jbe 
    // Assembly: jbe 0x3cbf
    if (jbe_condition) goto label_3cbf;
    // 0x3caa: push 
    // Assembly: push ebx
    // Push temp1 to stack
    // 0x3cab: call 
...
int text_x86_00003d30(void)
{
    ...
    counter = temp1;
    // 0x3d43: mov 
    // Assembly: mov dword ptr [esi], 0
    memory_access = 0;
    // 0x3d49: mov 
    // Assembly: mov dword ptr [esi + 4], 0
    memory_access = 0;
    // 0x3d50: call 
...
int text_func_2e00(void)
{
    ...
    counter = *((int*)(memory_access));
    // 0x3e05: mov 
    // Assembly: mov edx, dword ptr [esi + 8]
    temp2 = *((int*)(memory_access));
    // 0x3e08: sub 
    ...
    // 0x3e10: jbe 
    // Assembly: jbe 0x3eda
    if (jbe_condition) goto label_3eda;
    // 0x3e16: cmp 
    // Assembly: cmp ebx, edi
    // Compare: temp1 vs dst_ptr
    // 0x3e18: mov 
    // Assembly: mov dword ptr [ebp + 0xc], edi
    *((int*)(memory_access)) = dst_ptr;
    // 0x3e1b: lea 
    ...
    // 0x3e1e: jb 
    // Assembly: jb 0x3e23
    if (jb_condition) goto label_3e23;
    // 0x3e20: lea 
    // Assembly: lea eax, [ebp - 4]
    // lea eax, [ebp - 4]
    label_3e23:
    // 0x3e23: mov 
    // Assembly: mov edx, dword ptr [eax]
    temp2 = *((int*)(memory_access));
    // 0x3e25: lea 
...
int text_x86_00003f90(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    // 0x3fb6: mov 
    // Assembly: mov dword ptr [esi + 8], eax
    *((int*)(memory_access)) = result;
    // 0x3fb9: mov 
    // Assembly: mov dword ptr [ebp - 4], eax
    *((int*)(memory_access)) = result;
...
int text_x86_00003ff0(void)
{
    ...
    result = func_3d30();
    // 0x4006: mov 
    // Assembly: mov edx, dword ptr [esi + 4]
    temp2 = *((int*)(memory_access));
    // 0x4009: mov 
    // Assembly: mov eax, esi
    result = src_ptr;
    // 0x400b: mov 
    // Assembly: mov byte ptr [edx], 0
    memory_access = 0;
    // 0x400e: pop 
    // Assembly: pop esi
    // Pop from stack to src_ptr
...
int text_x86_00004270(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0x4290: mov 
    // Assembly: mov dword ptr [ebp - 0x18], 0
    memory_access = 0;
    // 0x4297: call 
...
int text_x86_000043b0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push dst_ptr to stack
    // 0x43d3: mov 
    // Assembly: mov edi, dword ptr [ebp + 0x10]
    dst_ptr = *((int*)(memory_access));
    // 0x43d6: mov 
    // Assembly: mov eax, dword ptr [edi + 4]
    result = *((int*)(memory_access));
    // 0x43d9: mov 
    // Assembly: mov edx, dword ptr [edi]
    temp2 = *((int*)(memory_access));
    // 0x43db: sub 
...
int text_x86_00004490(void)
{
    ...
    *((int*)(memory_access)) = result;
    // 0x44b6: mov 
    // Assembly: mov eax, dword ptr [0x4d26cc]
    result = *((int*)(memory_access));
    // 0x44bb: test 
    // Assembly: test eax, eax
    // Compare: result vs result
...
int text_x86_000047d0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push src_ptr to stack
    // 0x47ec: mov 
    // Assembly: mov esi, dword ptr [0x4a976c]
    src_ptr = *((int*)(memory_access));
    // 0x47f2: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    ...
    // 0x47fc: ja 
    // Assembly: ja 0x48a2
    if (ja_condition) goto label_48a2;
}
...
int text_x86_000059be(void)
{
    ...
    dst_ptr = dst_ptr;
    // 0x59c0: or 
    // Assembly: or dword ptr [eax + 0x40], ecx
    // or dword ptr [eax + 0x40], ecx
    // 0x59c3: add 
    // Assembly: add byte ptr [eax + ecx*2], ah
    // add byte ptr [eax + ecx*2], ah
    // 0x59c6: inc 
    // Assembly: inc eax
    // inc eax
    // 0x59c7: add 
    // Assembly: add byte ptr [ebx], bh
    // add byte ptr [ebx], bh
    // 0x59c9: dec 
    // Assembly: dec eax
    // dec eax
    ...
    // inc eax
    // 0x59cb: add 
    // Assembly: add byte ptr [eax + 0x48], cl
    // add byte ptr [eax + 0x48], cl
    // 0x59ce: inc 
    // Assembly: inc eax
    // inc eax
    // 0x59cf: add 
    // Assembly: add byte ptr [edx - 0x5dffbfb8], ah
    // add byte ptr [edx - 0x5dffbfb8], ah
    // 0x59d5: dec 
    // Assembly: dec eax
    // dec eax
    // 0x59d6: inc 
    ...
    // inc eax
    // 0x59d7: add 
    // Assembly: add byte ptr [ecx + 0x48], dl
    // add byte ptr [ecx + 0x48], dl
    // 0x59da: inc 
    // Assembly: inc eax
    // inc eax
    // 0x59db: add 
    // Assembly: add byte ptr [esi + 0x48], dh
    // add byte ptr [esi + 0x48], dh
    // 0x59de: inc 
    // Assembly: inc eax
    // inc eax
    // 0x59df: add 
...
int text_x86_00005a20(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0x5a47: ja 
    // Assembly: ja 0x5fe0
    if (ja_condition) goto label_5fe0;
    // 0x5a4d: push 
    // Assembly: push ebx
    // Push temp1 to stack
    // 0x5a4e: push 
...
int text_x86_000060b0(void)
{
    ...
    // 0x60be: ja 
    // Assembly: ja 0x6170
    if (ja_condition) goto label_6170;
    // 0x60c4: jmp 
    // Assembly: jmp dword ptr [eax*4 + 0x40617c]
    // jmp dword ptr [eax*4 + 0x40617c]
    // 0x60cb: push 
    // Assembly: push 0xc4
    // Push 0xc4 to stack
    // 0x60d0: call 
...
int text_x86_000061c0(void)
{
    ...
    // Push temp1 to stack
    // 0x61c7: mov 
    // Assembly: mov ebx, dword ptr [ebp + 0x10]
    temp1 = *((int*)(memory_access));
    // 0x61ca: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    src_ptr = counter;
    // 0x61d1: mov 
    // Assembly: mov ecx, dword ptr [esi + 0x20]
    counter = *((int*)(memory_access));
    // 0x61d4: lea 
    // Assembly: lea eax, [ebp + 0xc]
    // lea eax, [ebp + 0xc]
    ...
    // Push counter to stack
    // 0x61d9: call 
    // Assembly: call dword ptr [0x4a977c]
    result = function_ptr();
    // 0x61df: mov 
    // Assembly: mov eax, dword ptr [esi + 0x818]
    result = *((int*)(memory_access));
    // 0x61e5: lea 
...
int text_x86_000062f0(void)
{
    ...
    result = func_8b802();
    // 0x62fb: cmp 
    // Assembly: cmp dword ptr [ebp + 8], 1
    // Compare: dword ptr [ebp + 8] vs 1
    // 0x62ff: jne 
    // Assembly: jne 0x6315
    if (!zero_flag) goto label_6315;
    // 0x6301: push 
    // Assembly: push 0
    // Push 0 to stack
    // 0x6303: lea 
    // Assembly: lea eax, [ebp + 8]
    // lea eax, [ebp + 8]
    // 0x6306: push 
    // Assembly: push eax
    // Push result to stack
    ...
    counter = src_ptr;
    // 0x6309: mov 
    // Assembly: mov dword ptr [ebp + 8], 0xe
    memory_access = 0xe;
    // 0x6310: call 
    // Assembly: call 0x5a20
    result = func_5a20();
...
int text_x86_00006320(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x6323: cmp 
    // Assembly: cmp dword ptr [ecx + 0x74], 7
    // Compare: dword ptr [ecx + 0x74] vs 7
    // 0x6327: jne 
    // Assembly: jne 0x6341
    if (!zero_flag) goto label_6341;
    // 0x6329: cmp 
    // Assembly: cmp dword ptr [ebp + 8], 0x74
    // Compare: dword ptr [ebp + 8] vs 0x74
    // 0x632d: jne 
    // Assembly: jne 0x6341
    if (!zero_flag) goto label_6341;
    // 0x632f: push 
    ...
    // Push result to stack
    // 0x6335: mov 
    // Assembly: mov dword ptr [ebp + 8], 0x13
    memory_access = 0x13;
    // 0x633c: call 
    // Assembly: call 0x5a20
    result = func_5a20();
...
int text_x86_00006350(void)
{
    ...
    // Push counter to stack
    // 0x6354: mov 
    // Assembly: mov eax, dword ptr [ecx + 0x74]
    result = *((int*)(memory_access));
    // 0x6357: dec 
    // Assembly: dec eax
    // dec eax
    ...
    // 0x635b: ja 
    // Assembly: ja 0x643b
    if (ja_condition) goto label_643b;
    // 0x6361: jmp 
    // Assembly: jmp dword ptr [eax*4 + 0x406444]
    // jmp dword ptr [eax*4 + 0x406444]
    // 0x6368: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
    // 0x636b: cmp 
    ...
    // 0x636e: je 
    // Assembly: je 0x6379
    if (zero_flag) goto label_6379;
    // 0x6370: cmp 
    // Assembly: cmp eax, 0xd
    // Compare: result vs 0xd
    // 0x6373: jne 
    // Assembly: jne 0x643b
    if (!zero_flag) goto label_643b;
    label_6379:
    // 0x6379: lea 
    // Assembly: lea eax, [ebp - 4]
    // lea eax, [ebp - 4]
...
int text_x86_00006470(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    result = 185;
    // 0x6493: mov 
    // Assembly: mov dword ptr [ebp - 0x38], eax
    *((int*)(memory_access)) = result;
    // 0x6496: mov 
    // Assembly: mov dword ptr [ebp - 0x34], eax
    *((int*)(memory_access)) = result;
    // 0x6499: mov 
    // Assembly: mov eax, 0x3a83126f
    result = 981668463;
    // 0x649e: mov 
    // Assembly: mov dword ptr [ebp - 0x18], eax
    *((int*)(memory_access)) = result;
}
...
int text_x86_00006920(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    src_ptr = counter;
    // 0x693e: cmp 
    // Assembly: cmp dword ptr [esi + 0x74], 3
    // Compare: dword ptr [esi + 0x74] vs 3
    // 0x6942: jne 
    // Assembly: jne 0x6c65
    if (!zero_flag) goto label_6c65;
    // 0x6948: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
    // 0x694b: mov 
...
int text_x86_00006ca0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0x6cc4: je 
    // Assembly: je 0x6ccf
    if (zero_flag) goto label_6ccf;
    // 0x6cc6: cmp 
    // Assembly: cmp eax, 9
    // Compare: result vs 9
    // 0x6cc9: jne 
    // Assembly: jne 0x71a4
    if (!zero_flag) goto label_71a4;
    label_6ccf:
    // 0x6ccf: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
...
int text_x86_000071e0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    src_ptr = counter;
    // 0x7201: mov 
    // Assembly: mov ecx, dword ptr [0x4d2598]
    counter = *((int*)(memory_access));
    // 0x7207: mov 
    // Assembly: mov eax, dword ptr [ecx]
    result = *((int*)(memory_access));
...
int text_x86_00007630(void)
{
    ...
    result = func_71e0();
    // 0x7641: mov 
    // Assembly: mov al, byte ptr [esi + 0x9b8]
    result = memory_access;
    // 0x7647: test 
    // Assembly: test al, al
    // Compare: al vs al
    // 0x7649: mov 
    // Assembly: mov ebx, dword ptr [0x4a9774]
    temp1 = *((int*)(memory_access));
    // 0x764f: je 
    // Assembly: je 0x766a
    if (zero_flag) goto label_766a;
    // 0x7651: mov 
    // Assembly: mov eax, dword ptr [esi + 0x97c]
    result = *((int*)(memory_access));
    // 0x7657: push 
    // Assembly: push eax
    // Push result to stack
...
int text_x86_00007740(void)
{
    ...
    src_ptr = counter;
    // 0x7747: mov 
    // Assembly: mov cl, byte ptr [0x4d2730]
    result = memory_access;
    // 0x774d: mov 
    // Assembly: mov eax, 1
    result = 1;
    ...
    // Push dst_ptr to stack
    // 0x7755: mov 
    // Assembly: mov edi, dword ptr [0x4a97e4]
    dst_ptr = *((int*)(memory_access));
    // 0x775b: jne 
    // Assembly: jne 0x776a
    if (!zero_flag) goto label_776a;
    // 0x775d: or 
    // Assembly: or dword ptr [0x4d2730], eax
    // or dword ptr [0x4d2730], eax
    // 0x7763: call 
    // Assembly: call edi
    result = edi();
    // 0x7765: mov 
    // Assembly: mov dword ptr [0x4d272c], eax
    *((int*)(memory_access)) = result;
    label_776a:
    // 0x776a: mov 
    // Assembly: mov eax, dword ptr [esi + 0x48]
    result = *((int*)(memory_access));
    // 0x776d: mov 
    // Assembly: mov cl, byte ptr [eax + 0x68]
    result = memory_access;
    // 0x7770: test 
}
...
int text_x86_00007830(void)
{
    ...
    *((int*)(memory_access)) = result;
    // 0x7847: mov 
    // Assembly: mov dword ptr [ebp - 0x88], 0
    memory_access = 0;
    // 0x7851: jne 
    // Assembly: jne 0x7856
    if (!zero_flag) goto label_7856;
    // 0x7853: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x7854: jmp 
    ...
    // Push counter to stack
    // 0x7857: call 
    // Assembly: call dword ptr [0x4a96d4]
    result = function_ptr();
    // 0x785d: add 
    // Assembly: add esp, 4
    stack_ptr = stack_ptr + 4;
...
int text_x86_000078d0(void)
{
    ...
    result = func_8b9be();
    // 0x78e7: mov 
    // Assembly: mov edx, dword ptr [ebp - 4]
    temp2 = *((int*)(memory_access));
    // 0x78ea: mov 
    // Assembly: mov eax, dword ptr [edi + 0x20]
    result = *((int*)(memory_access));
    // 0x78ed: mov 
    // Assembly: mov ebx, dword ptr [0x4a97b0]
    temp1 = *((int*)(memory_access));
    // 0x78f3: push 
    // Assembly: push edx
}
...
int text_x86_00007930(void)
{
    ...
    // Push counter to stack
    // 0x7934: mov 
    // Assembly: mov ecx, dword ptr [ecx + 0x58]
    counter = *((int*)(memory_access));
    // 0x7937: test 
    // Assembly: test ecx, ecx
    // Compare: counter vs counter
...
int text_x86_000079a0(void)
{
    ...
    result = *((int*)(memory_access));
    // 0x79a9: mov 
    // Assembly: mov edx, dword ptr [ebx]
    temp2 = *((int*)(memory_access));
    // 0x79ab: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    // 0x79b4: jbe 
    // Assembly: jbe 0x79c3
    if (jbe_condition) goto label_79c3;
    // 0x79b6: push 
    ...
    label_79c3:
    // 0x79c3: mov 
    // Assembly: mov edx, dword ptr [ebx + 4]
    temp2 = *((int*)(memory_access));
    // 0x79c6: mov 
}
...
int text_x86_00007b50(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    // 0x7b71: mov 
    // Assembly: mov dword ptr [esi], 0x4ab528
    memory_access = 0x4ab528;
    // 0x7b77: mov 
    // Assembly: mov al, byte ptr [esi + 0x54]
    result = memory_access;
    // 0x7b7a: test 
    // Assembly: test al, al
    // Compare: al vs al
...
int text_x86_00007dd0(void)
{
    ...
    // 0x7ddf: mov 
    // Assembly: mov esi, dword ptr [edi]
    src_ptr = *((int*)(memory_access));
    // 0x7de1: je 
    // Assembly: je 0x7df8
    if (zero_flag) goto label_7df8;
    label_7de3:
    // 0x7de3: cmp 
    // Assembly: cmp esi, dword ptr [edi + 4]
    // Compare: src_ptr vs dword ptr [edi + 4]
    // 0x7de6: je 
    // Assembly: je 0x7df4
    if (zero_flag) goto label_7df4;
    // 0x7de8: mov 
    // Assembly: mov dl, byte ptr [eax]
    result = memory_access;
    // 0x7dea: inc 
...
int text_x86_00007ea0(void)
{
    ...
    // Push dst_ptr to stack
    // 0x7eae: mov 
    // Assembly: mov edi, dword ptr [ebp + 0x18]
    dst_ptr = *((int*)(memory_access));
    // 0x7eb1: mov 
    // Assembly: mov esi, ecx
    src_ptr = counter;
    ...
    *((int*)(memory_access)) = result;
    ...
    // lea ecx, [esi + 0x80]
    // 0x7ecc: mov 
    // Assembly: mov dword ptr [esi + 0x58], edi
}
...
int text_x86_00008070(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    src_ptr = counter;
    // 0x808e: mov 
    // Assembly: mov al, byte ptr [esi + 0x5c]
    result = memory_access;
    // 0x8091: test 
    // Assembly: test al, al
    // Compare: al vs al
    // 0x8093: je 
    // Assembly: je 0x83e8
    if (zero_flag) goto label_83e8;
    // 0x8099: cmp 
    // Assembly: cmp dword ptr [esi + 0x64], 3
    // Compare: dword ptr [esi + 0x64] vs 3
    // 0x809d: jne 
    // Assembly: jne 0x80ae
    if (!zero_flag) goto label_80ae;
    // 0x809f: mov 
    // Assembly: mov eax, dword ptr [esi + 0x58]
    result = *((int*)(memory_access));
}
...
int text_x86_000085f0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0x85f3: mov 
    // Assembly: mov al, byte ptr [ecx + 0x5c]
    result = memory_access;
    // 0x85f6: test 
    // Assembly: test al, al
    // Compare: al vs al
    ...
    result = *((int*)(memory_access));
    // 0x8603: cmp 
    // Assembly: cmp byte ptr [eax], 0
    // Compare: byte ptr [eax] vs 0
    // 0x8606: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x8607: push 
...
int text_x86_000086a0(void)
{
    ...
    // 0x86ab: je 
    // Assembly: je 0x86bf
    if (zero_flag) goto label_86bf;
    // 0x86ad: mov 
    // Assembly: mov edx, dword ptr [eax + 4]
    temp2 = *((int*)(memory_access));
    // 0x86b0: mov 
    // Assembly: mov eax, dword ptr [eax]
    result = *((int*)(memory_access));
...
int text_x86_000086d0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0x86f1: je 
    // Assembly: je 0x871d
    if (zero_flag) goto label_871d;
    // 0x86f3: lea 
    // Assembly: lea ecx, [ebp - 0x10]
    // lea ecx, [ebp - 0x10]
    // 0x86f6: call 
    // Assembly: call dword ptr [0x4a9390]
    result = function_ptr();
    // 0x86fc: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
...
int text_x86_00008770(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    src_ptr = counter;
    // 0x8797: mov 
    // Assembly: mov byte ptr [ebp - 0xd], bl
    memory_access = bl;
    // 0x879a: call 
...
int text_x86_00008840(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    src_ptr = counter;
    // 0x885f: mov 
    // Assembly: mov eax, dword ptr [esi + 0x64]
    result = *((int*)(memory_access));
    // 0x8862: dec 
    // Assembly: dec eax
    // dec eax
...
int text_x86_00008ee0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    result = *((int*)(memory_access));
    // 0x8f05: cmp 
    // Assembly: cmp eax, dword ptr [edi]
    // Compare: result vs dword ptr [edi]
    // 0x8f07: je 
    // Assembly: je 0x91a1
    if (zero_flag) goto label_91a1;
    // 0x8f0d: push 
    // Assembly: push ebx
    // Push temp1 to stack
    // 0x8f0e: lea 
...
int text_x86_000091d0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push dst_ptr to stack
    // 0x91ed: mov 
    // Assembly: mov edi, dword ptr [ebp + 0x14]
    dst_ptr = *((int*)(memory_access));
    // 0x91f0: xor 
    // Assembly: xor ebx, ebx
    temp1 = temp1 ^ temp1;
    ...
    // 0x91f4: je 
    // Assembly: je 0x9578
    if (zero_flag) goto label_9578;
    // 0x91fa: cmp 
    // Assembly: cmp byte ptr [edi + 0x5c], bl
    // Compare: byte ptr [edi + 0x5c] vs bl
}
...
int text_x86_000095c0(void)
{
    ...
    result = func_8b898();
    // 0x95d5: mov 
    // Assembly: mov dword ptr [esi + 0x74], edi
    *((int*)(memory_access)) = dst_ptr;
    // 0x95d8: pop 
    // Assembly: pop edi
    // Pop from stack to dst_ptr
    // 0x95d9: mov 
    // Assembly: mov dword ptr [esi], 0x4abd60
...
int text_x86_00009610(void)
{
    ...
    // 0x9622: je 
    // Assembly: je 0x9680
    if (zero_flag) goto label_9680;
    // 0x9624: mov 
    // Assembly: mov eax, dword ptr [eax + 0x20]
    result = *((int*)(memory_access));
    // 0x9627: push 
    // Assembly: push 0
    // Push 0 to stack
    ...
    // Push result to stack
    // 0x9631: call 
    // Assembly: call dword ptr [0x4a97b0]
    result = function_ptr();
    // 0x9637: cmp 
    // Assembly: cmp eax, 1
    // Compare: result vs 1
...
int text_x86_00009716(void)
{
    ...
    // 0x9718: mov 
    // Assembly: mov dword ptr [eax], 0x24
    memory_access = 0x24;
    // 0x971e: mov 
    // Assembly: mov dword ptr [eax + 0x18], ecx
    *((int*)(memory_access)) = counter;
    // 0x9721: mov 
    // Assembly: mov dword ptr [eax + 0x1c], ecx
    *((int*)(memory_access)) = counter;
    // 0x9724: mov 
    // Assembly: mov dword ptr [eax + 0x20], ecx
    *((int*)(memory_access)) = counter;
    // 0x9727: ret 
    // Assembly: ret 
    return result;
...
int text_x86_00009840(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    stack_ptr = stack_ptr - 8;
    // 0x985b: mov 
    // Assembly: mov al, byte ptr [0x4d2c68]
    result = memory_access;
    // 0x9860: test 
    // Assembly: test al, al
    // Compare: al vs al
    ...
    // Push dst_ptr to stack
    // 0x9865: mov 
    // Assembly: mov byte ptr [ebp - 0xd], 1
    memory_access = 1;
    // 0x9869: je 
    // Assembly: je 0x9882
    if (zero_flag) goto label_9882;
    // 0x986b: mov 
    // Assembly: mov ebx, dword ptr [ebp + 8]
    temp1 = *((int*)(memory_access));
    // 0x986e: mov 
...
int text_x86_00009950(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push temp1 to stack
    // 0x9974: mov 
    // Assembly: mov ebx, dword ptr [0x4a96a4]
    temp1 = *((int*)(memory_access));
    // 0x997a: push 
    // Assembly: push esi
    // Push src_ptr to stack
...
int text_x86_0000a000(void)
{
    ...
    stack_ptr = stack_ptr - 8;
    // 0xa006: mov 
    // Assembly: mov eax, dword ptr [0x4d2c5c]
    result = *((int*)(memory_access));
    // 0xa00b: push 
    // Assembly: push ebx
    // Push temp1 to stack
    // 0xa00c: mov 
    // Assembly: mov ebx, dword ptr [0x4a9708]
    temp1 = *((int*)(memory_access));
    // 0xa012: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    // Push dst_ptr to stack
    // 0xa016: mov 
    // Assembly: mov edi, dword ptr [0x4a9704]
    dst_ptr = *((int*)(memory_access));
    // 0xa01c: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    // 0xa01e: mov 
    // Assembly: mov eax, dword ptr [0x4d2c60]
    result = *((int*)(memory_access));
    // 0xa023: mov 
    // Assembly: mov dword ptr [ebp - 4], ecx
    *((int*)(memory_access)) = counter;
    // 0xa026: jle 
    // Assembly: jle 0xa076
    if (jle_condition) goto label_a076;
    // 0xa028: mov 
    // Assembly: mov esi, dword ptr [eax + ecx*4]
    src_ptr = *((int*)(memory_access));
    // 0xa02b: test 
    // Assembly: test esi, esi
    // Compare: src_ptr vs src_ptr
...
int text_x86_0000a0c0(void)
{
    ...
    *((int*)(memory_access)) = result;
    // 0xa0d5: mov 
    // Assembly: mov dword ptr [ebp - 0x130], ebx
    *((int*)(memory_access)) = temp1;
    // 0xa0db: call 
    // Assembly: call dword ptr [0x4a9158]
    result = function_ptr();
    // 0xa0e1: push 
    // Assembly: push eax
    // Push result to stack
...
int text_x86_0000a300(void)
{
    ...
    // Push dst_ptr to stack
    // 0xa30b: mov 
    // Assembly: mov edi, dword ptr [0x4a96c0]
    dst_ptr = *((int*)(memory_access));
    // 0xa311: lea 
...
int text_x86_0000a420(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0xa440: call 
    // Assembly: call dword ptr [0x4a907c]
    result = function_ptr();
    // 0xa446: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    // 0xa448: mov 
    // Assembly: mov dword ptr [0x4d2c50], eax
    *((int*)(memory_access)) = result;
    // 0xa44d: jne 
    // Assembly: jne 0xa4b5
    if (!zero_flag) goto label_a4b5;
}
...
int text_x86_0000a4d0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    stack_ptr = stack_ptr - 12;
    // 0xa4eb: mov 
    // Assembly: mov eax, dword ptr [0x4d2c50]
    result = *((int*)(memory_access));
    // 0xa4f0: push 
    // Assembly: push ebx
    // Push temp1 to stack
    ...
    // Push src_ptr to stack
    // 0xa4f2: mov 
    // Assembly: mov esi, dword ptr [0x4d2530]
    src_ptr = *((int*)(memory_access));
    // 0xa4f8: push 
    // Assembly: push edi
    // Push dst_ptr to stack
...
int text_x86_0000a7c0(void)
{
    ...
    stack_ptr = stack_ptr - 12;
    // 0xa7c6: mov 
    // Assembly: mov al, byte ptr [0x4d3170]
    result = memory_access;
    // 0xa7cb: test 
    // Assembly: test al, al
    // Compare: al vs al
    // 0xa7cd: jne 
    // Assembly: jne 0xa872
    if (!zero_flag) goto label_a872;
    // 0xa7d3: mov 
    // Assembly: mov eax, dword ptr [0x4d325c]
    result = *((int*)(memory_access));
    // 0xa7d8: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    ...
    // 0xa7ec: call 
    // Assembly: call dword ptr [0x4a96bc]
    result = function_ptr();
}
...
int text_x86_0000a880(void)
{
    ...
    *((int*)(memory_access)) = result;
    ...
    // Push result to stack
    // 0xa89e: call 
    // Assembly: call dword ptr [0x4a96e0]
    result = function_ptr();
    // 0xa8a4: call 
    // Assembly: call dword ptr [0x4a96b4]
    result = function_ptr();
    // 0xa8aa: mov 
    // Assembly: mov ecx, dword ptr [eax]
    counter = *((int*)(memory_access));
...
int text_x86_0000abf0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0xabf3: mov 
    // Assembly: mov al, byte ptr [ebp + 8]
    result = memory_access;
    // 0xabf6: mov 
    // Assembly: mov byte ptr [ecx + 0xb0], al
    memory_access = al;
    // 0xabfc: pop 
    // Assembly: pop ebp
    // Pop from stack to frame_ptr
...
int text_x86_0000b360(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    stack_ptr = stack_ptr - 28;
    // 0xb37b: mov 
    // Assembly: mov ecx, dword ptr [0x4d2c58]
    counter = *((int*)(memory_access));
    // 0xb381: test 
    // Assembly: test ecx, ecx
    // Compare: counter vs counter
    // 0xb383: je 
    // Assembly: je 0xb418
    if (zero_flag) goto label_b418;
    // 0xb389: mov 
    // Assembly: mov eax, dword ptr [0x4d6304]
    result = *((int*)(memory_access));
    // 0xb38e: test 
    // Assembly: test eax, eax
    // Compare: result vs result
...
int text_x86_0000bd20(void)
{
    ...
    // 0xbd32: je 
    // Assembly: je 0xbd3b
    if (zero_flag) goto label_bd3b;
    // 0xbd34: mov 
    // Assembly: mov edx, dword ptr [ebp + 8]
    temp2 = *((int*)(memory_access));
    // 0xbd37: mov 
    // Assembly: mov edx, dword ptr [edx]
    temp2 = *((int*)(memory_access));
    // 0xbd39: mov 
    // Assembly: mov dword ptr [ecx], edx
    *((int*)(memory_access)) = temp2;
    label_bd3b:
    // 0xbd3b: pop 
    // Assembly: pop ebp
...
int text_x86_0000bdb0(void)
{
    ...
    *((int*)(memory_access)) = dst_ptr;
    // 0xbdd0: mov 
    // Assembly: mov dword ptr [edi], 0x4ac8f0
...
int text_template_0000bf05(void)
{
    ...
    // dec edx
    // 0xbf08: add 
    // Assembly: add byte ptr [ebx + 0x4d357c35], cl
    // add byte ptr [ebx + 0x4d357c35], cl
    // 0xbf0e: add 
    // Assembly: add byte ptr [ecx + 0x4d357c3d], cl
    // add byte ptr [ecx + 0x4d357c3d], cl
    // 0xbf14: add 
    // Assembly: add byte ptr [ebp - 0xa88b82], cl
    // add byte ptr [ebp - 0xa88b82], cl
    // 0xbf1a: adc 
    // Assembly: adc eax, 0x4a908c
    // adc eax, 0x4a908c
    // 0xbf1f: mov 
    // Assembly: mov eax, dword ptr [esi]
    result = *((int*)(memory_access));
    // 0xbf21: mov 
    // Assembly: mov ecx, esi
    counter = src_ptr;
    ...
    // Push dst_ptr to stack
    // 0xbf27: call 
    // Assembly: call dword ptr [0x4a9088]
    result = function_ptr();
    // 0xbf2d: mov 
    // Assembly: mov edx, dword ptr [esi]
    temp2 = *((int*)(memory_access));
    // 0xbf2f: push 
    // Assembly: push 1
    // Push 1 to stack
...
int text_x86_0000bf50(void)
{
    ...
    result = func_8ba96();
    // 0xbf6a: mov 
    // Assembly: mov dword ptr [0x4d3580], esi
    *((int*)(memory_access)) = src_ptr;
    // 0xbf70: mov 
    // Assembly: mov al, 1
    // mov al, 1
...
int text_x86_0000c400(void)
{
    ...
    counter = *((int*)(memory_access));
    // 0xc409: call 
    // Assembly: call dword ptr [0x4a93f4]
    result = function_ptr();
    // 0xc40f: push 
    // Assembly: push eax
    // Push result to stack
    ...
    // Push result to stack
    // 0xc426: call 
    // Assembly: call dword ptr [0x4a97bc]
    result = function_ptr();
    // 0xc42c: mov 
    // Assembly: mov ecx, dword ptr [0x4d3580]
}
...
int text_x86_0000c4d0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    stack_ptr = stack_ptr - 40;
    // 0xc4eb: mov 
    // Assembly: mov eax, dword ptr [0x4d357c]
    result = *((int*)(memory_access));
    // 0xc4f0: test 
    // Assembly: test eax, eax
    // Compare: result vs result
...
int text_x86_0000c7f0(void)
{
    ...
    stack_ptr = stack_ptr - 24;
    // 0xc7f6: mov 
    // Assembly: mov ecx, dword ptr [0x4d357c]
    counter = *((int*)(memory_access));
    // 0xc7fc: test 
    // Assembly: test ecx, ecx
    // Compare: counter vs counter
    ...
    label_c81c:
    // 0xc81c: call 
    // Assembly: call dword ptr [0x4a9754]
    result = function_ptr();
}
...
int text_x86_0000c8e0(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    // 0xc8ff: mov 
    // Assembly: mov dword ptr [esi], 0x4aca90
...
int text_x86_0000c950(void)
{
    ...
    // Push temp1 to stack
    // 0xc957: mov 
    // Assembly: mov ebx, dword ptr [ebp + 0x18]
    temp1 = *((int*)(memory_access));
    // 0xc95a: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    src_ptr = counter;
    // 0xc95d: mov 
    // Assembly: mov ecx, dword ptr [ebp + 0x14]
    counter = *((int*)(memory_access));
    // 0xc960: push 
    // Assembly: push edi
    // Push dst_ptr to stack
    ...
    // Push temp2 to stack
    // 0xc968: mov 
    // Assembly: mov edx, dword ptr [ebp + 0x10]
    temp2 = *((int*)(memory_access));
    // 0xc96b: add 
...
int text_x86_0000c9f0(void)
{
    ...
    temp2 = *((int*)(memory_access));
    // 0xc9f6: fld 
    // Assembly: fld dword ptr [edx]
    // fld dword ptr [edx]
    // 0xc9f8: fcomp 
    // Assembly: fcomp dword ptr [0x4aafcc]
    // fcomp dword ptr [0x4aafcc]
    // 0xc9fe: fnstsw 
    // Assembly: fnstsw ax
    // fnstsw ax
    // 0xca00: test 
    ...
    // 0xca12: jp 
    // Assembly: jp 0xca2b
    if (jp_condition) goto label_ca2b;
    // 0xca14: fld 
    // Assembly: fld dword ptr [edx]
    // fld dword ptr [edx]
    // 0xca16: fcomp 
...
int text_x86_0000cb90(void)
{
    ...
    // inc eax
    // 0xcbae: mov 
    // Assembly: mov dword ptr [edi], eax
    *((int*)(memory_access)) = result;
    // 0xcbb0: pop 
    // Assembly: pop edi
    // Pop from stack to dst_ptr
...
int text_x86_0000cbc0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0xcbc3: movzx 
    // Assembly: movzx eax, word ptr [ebp + 0xc]
...
int text_x86_0000cc20(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push counter to stack
    // 0xcc39: mov 
    // Assembly: mov al, byte ptr [0x4d36b0]
    result = memory_access;
    // 0xcc3e: test 
    // Assembly: test al, al
    // Compare: al vs al
...
int text_x86_0000cdd0(void)
{
    ...
    // Push counter to stack
    // 0xcdd4: mov 
    // Assembly: mov eax, dword ptr [ecx + 0x5c]
    result = *((int*)(memory_access));
    // 0xcdd7: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    ...
    *((int*)(memory_access)) = counter;
    ...
    label_cdf4:
    // 0xcdf4: mov 
    // Assembly: mov ecx, dword ptr [ecx + 0x20]
    counter = *((int*)(memory_access));
    // 0xcdf7: push 
}
...
int text_x86_0000cea0(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0xcea3: mov 
    // Assembly: mov ecx, dword ptr [ecx + 0x5c]
    counter = *((int*)(memory_access));
    // 0xcea6: test 
    // Assembly: test ecx, ecx
    // Compare: counter vs counter
...
int text_x86_0000cf40(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    stack_ptr = stack_ptr - 16;
    // 0xcf5b: mov 
    // Assembly: mov eax, dword ptr [0x4d3588]
    result = *((int*)(memory_access));
    // 0xcf60: cmp 
    // Assembly: cmp eax, 1
    // Compare: result vs 1
    ...
    // 0xcf66: jne 
    // Assembly: jne 0xcf96
    if (!zero_flag) goto label_cf96;
    // 0xcf68: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
    // 0xcf6b: mov 
    // Assembly: mov eax, dword ptr [eax + 8]
    result = *((int*)(memory_access));
    // 0xcf6e: mov 
    // Assembly: mov ebx, dword ptr [ebx + 8]
    temp1 = *((int*)(memory_access));
    // 0xcf71: push 
    // Assembly: push eax
}
...
int text_x86_0000d2c0(void)
{
    ...
    dst_ptr = *((int*)(memory_access));
    // 0xd2d6: mov 
    // Assembly: mov dword ptr [ebp - 0x10], ecx
    *((int*)(memory_access)) = counter;
    // 0xd2d9: add 
    // Assembly: add ecx, edi
    counter = counter + dst_ptr;
    // 0xd2db: mov 
    // Assembly: mov dword ptr [ebp - 8], ecx
    *((int*)(memory_access)) = counter;
    // 0xd2de: mov 
    // Assembly: mov ecx, dword ptr [ebp + 0x14]
    counter = *((int*)(memory_access));
    // 0xd2e1: mov 
    // Assembly: mov dword ptr [ebp - 0xc], edx
    *((int*)(memory_access)) = temp2;
    // 0xd2e4: add 
    // Assembly: add edx, ecx
    temp2 = temp2 + counter;
...
int text_x86_0000d470(void)
{
    ...
    // Push temp1 to stack
    // 0xd47a: mov 
    // Assembly: mov ebx, dword ptr [eax]
    temp1 = *((int*)(memory_access));
    // 0xd47c: mov 
    // Assembly: mov eax, dword ptr [ecx]
    result = *((int*)(memory_access));
    ...
    // Push dst_ptr to stack
    // 0xd482: mov 
    // Assembly: mov edi, dword ptr [ebx]
    dst_ptr = *((int*)(memory_access));
    // 0xd484: cmp 
    // Assembly: cmp edi, ebx
    // Compare: dst_ptr vs temp1
...
int text_x86_0000d530(void)
{
    ...
    src_ptr = counter;
    // 0xd536: mov 
    // Assembly: mov eax, dword ptr [esi + 0x5c]
    result = *((int*)(memory_access));
    // 0xd539: test 
    // Assembly: test eax, eax
    // Compare: result vs result
...
int text_x86_0000d6f0(void)
{
    ...
    src_ptr = counter;
    // 0xd6fa: mov 
    // Assembly: mov al, byte ptr [esi + 0x55]
    result = memory_access;
    // 0xd6fd: test 
    // Assembly: test al, al
    // Compare: al vs al
    // 0xd6ff: je 
    // Assembly: je 0xd720
    if (zero_flag) goto label_d720;
    // 0xd701: mov 
    // Assembly: mov eax, dword ptr [esi + 0x68]
    result = *((int*)(memory_access));
    // 0xd704: cmp 
    // Assembly: cmp dword ptr [eax], eax
    // Compare: dword ptr [eax] vs result
    // 0xd706: lea 
...
int text_x86_0000d820(void)
{
    ...
    result = func_8baf6();
    // 0xd83a: test 
    // Assembly: test byte ptr [ebp + 0x10], 1
    // Compare: byte ptr [ebp + 0x10] vs 1
    // 0xd83e: jne 
    // Assembly: jne 0xd883
    if (!zero_flag) goto label_d883;
    // 0xd840: test 
    // Assembly: test eax, eax
    // Compare: result vs result
    // 0xd842: jl 
...
int text_x86_0000d890(void)
{
    ...
    // 0xd8a8: jbe 
    // Assembly: jbe 0xd8b7
    if (jbe_condition) goto label_d8b7;
    // 0xd8aa: push 
    // Assembly: push ecx
    // Push counter to stack
    // 0xd8ab: call 
...
int text_x86_0000d8d0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    dst_ptr = *((int*)(memory_access));
    // 0xd8ee: mov 
    // Assembly: mov eax, dword ptr [edi]
    result = *((int*)(memory_access));
    // 0xd8f0: mov 
    // Assembly: mov esi, ecx
    src_ptr = counter;
    ...
    *((int*)(memory_access)) = result;
    // 0xd8f4: mov 
    // Assembly: mov ecx, dword ptr [edi + 4]
    counter = *((int*)(memory_access));
    // 0xd8f7: lea 
    // Assembly: lea edx, [edi + 8]
    // lea edx, [edi + 8]
    // 0xd8fa: mov 
    // Assembly: mov dword ptr [esi + 4], ecx
}
...
int text_x86_0000da90(void)
{
    ...
    temp1 = counter;
    // 0xda99: mov 
    // Assembly: mov al, byte ptr [ebx + 0x55]
    result = memory_access;
    // 0xda9c: test 
    // Assembly: test al, al
    // Compare: al vs al
    ...
    if (zero_flag) goto label_dba3;
    // 0xdaaf: mov 
    // Assembly: mov eax, dword ptr [ebx + 0x68]
    result = *((int*)(memory_access));
    // 0xdab2: push 
    // Assembly: push esi
    // Push src_ptr to stack
    ...
    // Push dst_ptr to stack
    // 0xdab8: mov 
    // Assembly: mov dword ptr [ebp - 0xc], 0
}
...
int text_x86_0000dbb0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push dst_ptr to stack
    // 0xdbce: mov 
    // Assembly: mov dword ptr [ebp - 0x10], esp
    *((int*)(memory_access)) = stack_ptr;
    // 0xdbd1: push 
    // Assembly: push 0x48
    // Push 0x48 to stack
    // 0xdbd3: mov 
    // Assembly: mov dword ptr [ebp - 0x18], ecx
    *((int*)(memory_access)) = counter;
    // 0xdbd6: call 
    // Assembly: call 0x3bd0
    result = func_3bd0();
...
int text_x86_0000ded0(void)
{
    ...
    *((int*)(memory_access)) = src_ptr;
    // 0xdef0: mov 
    // Assembly: mov dword ptr [esi], 0x4acd98
    ...
    // Compare: al vs al
    // 0xdefb: mov 
    // Assembly: mov dword ptr [ebp - 4], 6
    memory_access = 6;
}
...
int text_x86_0000dfd0(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // 0xdffa: je 
    // Assembly: je 0xe17e
    if (zero_flag) goto label_e17e;
    // 0xe000: cmp 
    // Assembly: cmp dword ptr [ecx], eax
}
...
int text_x86_0000e1c0(void)
{
    ...
    // Push result to stack
    // 0xe1de: mov 
    // Assembly: mov byte ptr [ebp - 1], 0
    memory_access = 0;
    // 0xe1e2: mov 
    // Assembly: mov dword ptr [ebp - 0x10], 0
    memory_access = 0;
    // 0xe1e9: call 
    // Assembly: call ebx
    result = ebx();
...
int text_x86_0000e480(void)
{
    ...
    *((int*)(memory_access)) = stack_ptr;
    ...
    // Push dst_ptr to stack
    // 0xe4a6: mov 
    // Assembly: mov edi, dword ptr [0x4a97b0]
    dst_ptr = *((int*)(memory_access));
    // 0xe4ac: push 
    // Assembly: push 0
    // Push 0 to stack
...
int text_x86_0000f070(void)
{
    ...
    // Push src_ptr to stack
    // 0xf074: mov 
    // Assembly: mov esi, dword ptr [ebp + 0x14]
    src_ptr = *((int*)(memory_access));
    // 0xf077: test 
    // Assembly: test esi, esi
    // Compare: src_ptr vs src_ptr
...
int text_x86_0000f180(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0xf183: mov 
    // Assembly: mov eax, dword ptr [ecx + 0x68]
    result = *((int*)(memory_access));
    // 0xf186: cmp 
    // Assembly: cmp dword ptr [eax], eax
    // Compare: dword ptr [eax] vs result
    // 0xf188: je 
    // Assembly: je 0xf1d9
    if (zero_flag) goto label_f1d9;
    // 0xf18a: mov 
    // Assembly: mov eax, dword ptr [ebp + 8]
    result = *((int*)(memory_access));
    // 0xf18d: mov 
    // Assembly: mov eax, dword ptr [eax + 0x10]
    result = *((int*)(memory_access));
    // 0xf190: inc 
    // Assembly: inc eax
    // inc eax
    ...
    // Compare: result vs 6
    // 0xf194: mov 
    // Assembly: mov dword ptr [0x4d3588], eax
    *((int*)(memory_access)) = result;
    // 0xf199: jge 
    // Assembly: jge 0xf1d9
    if (jge_condition) goto label_f1d9;
    // 0xf19b: mov 
    // Assembly: mov edx, dword ptr [eax*4 + 0x4d358c]
    temp2 = *((int*)(memory_access));
    // 0xf1a2: inc 
    // Assembly: inc edx
    // inc edx
    ...
    // Compare: temp2 vs 3
    // 0xf1a6: mov 
    // Assembly: mov dword ptr [eax*4 + 0x4d358c], edx
    *((int*)(memory_access)) = temp2;
    // 0xf1ad: jl 
    // Assembly: jl 0xf1ba
    if (less_than) goto label_f1ba;
}
...
int text_x86_0000f210(void)
{
    ...
    frame_ptr = stack_ptr;
    // 0xf213: mov 
    // Assembly: mov ecx, dword ptr [ecx + 0x54]
    counter = *((int*)(memory_access));
    // 0xf216: test 
    // Assembly: test ecx, ecx
    // Compare: counter vs counter
...
int text_x86_0000f2c0(void)
{
    ...
    result = *((int*)(memory_access));
    // 0xf2c6: fld 
    // Assembly: fld dword ptr [eax]
    // fld dword ptr [eax]
    // 0xf2c8: fadd 
    // Assembly: fadd dword ptr [ecx + 8]
    // fadd dword ptr [ecx + 8]
    // 0xf2cb: fstp 
    // Assembly: fstp dword ptr [ecx + 8]
...
int text_x86_0000f320(void)
{
    ...
    dst_ptr = counter;
    // 0xf329: mov 
    // Assembly: mov al, byte ptr [edi + 4]
    result = memory_access;
    // 0xf32c: test 
    // Assembly: test al, al
    // Compare: al vs al
    ...
    // Push src_ptr to stack
    // 0xf336: call 
    // Assembly: call dword ptr [0x4a9740]
    result = function_ptr();
    // 0xf33c: push 
    // Assembly: push eax
    // Push result to stack
    // 0xf33d: mov 
    // Assembly: mov dword ptr [ebp - 0x44], eax
    *((int*)(memory_access)) = result;
    // 0xf340: call 
    // Assembly: call dword ptr [0x4a973c]
    result = function_ptr();
    // 0xf346: mov 
    // Assembly: mov esi, eax
    src_ptr = result;
    ...
    // Push src_ptr to stack
    // 0xf349: mov 
    // Assembly: mov dword ptr [ebp - 0x40], esi
}
...
int text_helper_0001258f(void)
{
    ...
    // Converted from assembly instructions:
    // 0x1258f: jmp 
    // Assembly: jmp dword ptr [0x4d2550]
    // jmp dword ptr [0x4d2550]
    // 0x12595: push 
    // Assembly: push 0x412f08
    // Push 0x412f08 to stack
    // 0x1259a: push 
    // Assembly: push dword ptr [0x4fea0c]
    // Push dword ptr [0x4fea0c] to stack
}
...
int text_x86_00012868(void)
{
    ...
    // Converted from assembly instructions:
    // 0x12868: mov 
    // Assembly: mov eax, dword ptr [esp + 0x10]
    result = *((int*)(memory_access));
    // 0x1286c: and 
    // Assembly: and dword ptr [eax], 0
    // and dword ptr [eax], 0
    // 0x1286f: xor 
    // Assembly: xor eax, eax
    result = result ^ result;
    ...
    // Push -1 to stack
    // 0x12877: push 
    // Assembly: push dword ptr [esp + 0xc]
    // Push dword ptr [esp + 0xc] to stack
    // 0x1287b: push 
    // Assembly: push -1
    // Push -1 to stack
    // 0x1287d: push 
    // Assembly: push dword ptr [esp + 0x10]
    // Push dword ptr [esp + 0x10] to stack
    // 0x12881: push 
    // Assembly: push 1
    // Push 1 to stack
    // 0x12883: push 
    ...
    // Push 0x409 to stack
    // 0x12888: call 
    // Assembly: call dword ptr [0x4a909c]
    result = function_ptr();
    // 0x1288e: dec 
    // Assembly: dec eax
    // dec eax
...
int text_x86_00015a3a(void)
{
    ...
    // Push temp2 to stack
    // 0x15a5c: mov 
    // Assembly: mov dword ptr [ebp - 8], ebx
}
...
int text_x64_00072a8c(void)
{
    ...
    // dec eax
    // 0x72a8d: mov 
    // Assembly: mov dword ptr [esp + 0x10], edi
    *((int*)(memory_access)) = dst_ptr;
    // 0x72a91: or 
    // Assembly: or edi, edi
    dst_ptr = dst_ptr | dst_ptr;
    // 0x72a93: je 
    // Assembly: je 0x72ad1
    if (zero_flag) goto label_72ad1;
    // 0x72a95: mov 
    // Assembly: mov eax, dword ptr [esi + 8]
    result = *((int*)(memory_access));
    // 0x72a98: mov 
    // Assembly: mov ebx, dword ptr [esi + 0xc]
    temp1 = *((int*)(memory_access));
    // 0x72a9b: mov 
    // Assembly: mov ecx, dword ptr [ebp - 0x48]
    counter = *((int*)(memory_access));
    // 0x72a9e: mov 
    // Assembly: mov edx, dword ptr [ebp - 0x44]
    temp2 = *((int*)(memory_access));
    // 0x72aa1: xor 
    ...
    temp1 = temp1 ^ temp2;
    // 0x72aa5: mov 
    // Assembly: mov ecx, dword ptr [edi + 8]
    counter = *((int*)(memory_access));
    // 0x72aa8: mov 
    // Assembly: mov edx, dword ptr [edi + 0xc]
    temp2 = *((int*)(memory_access));
    // 0x72aab: xor 
    // Assembly: xor eax, ecx
    result = result ^ counter;
    ...
    temp1 = temp1 ^ temp2;
    // 0x72aaf: mov 
    // Assembly: mov dword ptr [esp + 8], eax
    *((int*)(memory_access)) = result;
    // 0x72ab3: mov 
    // Assembly: mov dword ptr [esp + 0xc], ebx
    *((int*)(memory_access)) = temp1;
    // 0x72ab7: mov 
    // Assembly: mov eax, dword ptr [esi]
}
...
int text_x86_0007e270(void)
{
    ...
    // Converted from assembly instructions:
    // 0x7e270: mov 
    // Assembly: mov ecx, dword ptr [esp + 4]
    counter = *((int*)(memory_access));
    // 0x7e274: mov 
    // Assembly: mov edx, dword ptr [esp + 8]
    temp2 = *((int*)(memory_access));
    // 0x7e278: mov 
    // Assembly: mov ecx, dword ptr [ecx]
    counter = *((int*)(memory_access));
    // 0x7e27a: push 
    // Assembly: push esi
    // Push src_ptr to stack
    // 0x7e27b: mov 
    // Assembly: mov esi, dword ptr [edx]
    src_ptr = *((int*)(memory_access));
    // 0x7e27d: xor 
    // Assembly: xor eax, eax
    result = result ^ result;
    ...
    // 0x7e281: je 
    // Assembly: je 0x7e2bc
    if (zero_flag) goto label_7e2bc;
    // 0x7e283: mov 
    // Assembly: mov edx, dword ptr [ecx + 0xc]
    temp2 = *((int*)(memory_access));
    // 0x7e286: test 
...
int text_x86_0007e4e1(void)
{
    ...
    // Converted from assembly instructions:
    // 0x7e4e1: mov 
    // Assembly: mov edx, dword ptr [esp + 4]
    temp2 = *((int*)(memory_access));
    // 0x7e4e5: mov 
    // Assembly: mov dx, word ptr [edx]
    result = memory_access;
    // 0x7e4e8: mov 
    // Assembly: mov word ptr [ecx], dx
    memory_access = dx;
    // 0x7e4eb: ret 
    // Assembly: ret 4
    return result;
    ...
    src_ptr = *((int*)(memory_access));
    // 0x7e508: mov 
    // Assembly: mov dword ptr [ecx], esi
    *((int*)(memory_access)) = src_ptr;
    // 0x7e50a: mov 
    // Assembly: mov esi, dword ptr [edx + 4]
}
