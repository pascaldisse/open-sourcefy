...
class CommanderLockeAgent:
    ...
    def _generate_build_files(self, analysis_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, str]:
        ...
        makefile_content = self._generate_makefile(analysis_data, context)
        build_files['Makefile'] = makefile_content
...
'''
    ...
    def _generate_makefile(self, analysis_data: Dict[str, Any], context: Dict[str, Any]) -> str:
        """Generate Makefile"""
        binary_info = context.get('binary_info', {})
        architecture = binary_info.get('architecture', 'x86')
        
        arch_flags = "-m64" if architecture == "x64" else "-m32"
