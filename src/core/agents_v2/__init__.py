...
try:
    ...
    from .agent10_machine import Agent10_TheMachine
    from .agent11_oracle import Agent11_TheOracle
...
def get_implementation_status() -> Dict[int, bool]:
    ...
    return {agent_id: agent_id in MATRIX_AGENTS for agent_id in range(9, 15)}
